      ...
      >
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-500 dark:text-zinc-400">
            Sign in to unlock exotic rentals and custom listings.
          </p>
        </div>
        ...
        <p className="mt-8 text-center text-sm text-gray-500 dark:text-zinc-400">
          ...
          <Link href="/register" className="font-bold text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 hover:underline">
            Register for free
          </Link>
        </p>
      </motion.div>
